...
<div class="h-full flex flex-col items-center justify-start pt-10" x-data="{ 
    ...
    <div class="w-full max-w-[1000px] bg-[#111111] rounded-[24px] p-8 md:p-14 border border-white/5 shadow-2xl relative overflow-hidden">
        ...
        {{-- Loading Overlay --}}
        <div x-show="isGenerating" x-cloak class="absolute inset-0 z-50 flex items-center justify-center">
            ...
            <div class="bg-[#222222] rounded-[16px] p-10 max-w-[400px] w-full relative z-10 border border-white/5 shadow-2xl transform transition-all">
                <h3 class="text-[#4D61FF] text-[22px] font-bold mb-2">Generating Lyric...</h3>
        ...
        <div class="flex items-center gap-4 mb-10 relative z-10">
            ...
            <h1 class="text-[32px] font-semibold text-[#4D61FF]">Lyric Generator</h1>
        </div>
        ...
        <div class="space-y-10 relative z-10">
            ...
            <div class="grid grid-cols-1 gap-8">
                {{-- Mood --}}
                <div class="space-y-4">
                    <label class="text-white text-[16px] font-medium">Mood</label>
                    <div class="relative">
                        <select x-model="mood" class="w-full bg-[#161719] border border-[#4D61FF]/30 rounded-[14px] px-6 py-4 text-white appearance-none outline-none focus:border-[#4D61FF] transition-all cursor-pointer font-medium">
                            <option>Happy</option>
                            <option>Sad</option>
                ...
                {{-- Theme --}}
                <div class="space-y-4">
                    <label class="text-white text-[16px] font-medium">Theme</label>
                    <div class="relative">
                        <select x-model="theme" class="w-full bg-[#161719] border border-[#4D61FF]/30 rounded-[14px] px-6 py-4 text-white appearance-none outline-none focus:border-[#4D61FF] transition-all cursor-pointer font-medium">
                            <option>Love</option>
                            <option>Life</option>
                ...
                {{-- Genre --}}
                <div class="space-y-4">
                    <label class="text-white text-[16px] font-medium">Genre</label>
                    <div class="relative">
                        <select x-model="genre" class="w-full bg-[#161719] border border-[#4D61FF]/30 rounded-[14px] px-6 py-4 text-white appearance-none outline-none focus:border-[#4D61FF] transition-all cursor-pointer font-medium">
                            <option>POP</option>
                            <option>R&B</option>
                ...
                <div class="space-y-4 pt-2">
                    <label class="text-white text-[16px] font-medium">Optional Ideas</label>
                    <input type="text" placeholder="Something you want to share..." class="w-full bg-transparent border-b border-white/10 py-4 text-white placeholder-gray-600 outline-none focus:border-[#4D61FF] transition-all font-medium">
                </div>
            </div>

            {{-- Action Button --}}
            <div class="pt-6">
                <button @click="runGenerator" class="w-full py-5 bg-[#4D61FF] hover:bg-[#3d4ed9] text-white font-bold rounded-[14px] text-[18px] transition-all transform active:scale-[0.98] shadow-lg shadow-[#4D61FF]/20">
                    Generate Lyric
                </button>
            </div>
        </div>

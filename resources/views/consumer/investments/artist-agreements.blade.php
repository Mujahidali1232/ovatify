...
<div class="max-w-4xl mx-auto mb-20 pr-4">
    ...
    <div class="bg-[#1b1c20] rounded-xl border border-white/5 p-10 shadow-2xl">
        {{-- Top Section --}}
        ...
        {{-- Legal Text --}}
        <div class="space-y-8 text-[15px] text-gray-300 leading-relaxed font-sans pr-4">
            <div>
                <h3 class="font-bold text-[15px] text-white mb-2">1. Grant of Rights</h3>
            ...
            <div>
                <h3 class="font-bold text-[15px] text-white mb-2">2. Compensation & Royalties</h3>
                <p class="mb-3">Royalties shall be split as follows:</p>
                <ul class="list-disc pl-5 mb-0.5 space-y-0.5 opacity-80">
                    <li>Artist: [Insert %]</li>
            ...
            <div>
                <h3 class="font-bold text-[15px] text-white mb-2">3. Ownership & Copyright</h3>
                <p>The copyright of the composition and master recording will be shared equally unless otherwise stated in writing.</p>
            </div>

            <div>
                <h3 class="font-bold text-[15px] text-white mb-2">4. Creative Control</h3>
